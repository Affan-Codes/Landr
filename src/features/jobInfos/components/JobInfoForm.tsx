...
const JobInfoForm = ({ jobInfo }: { jobInfo?: Pick<typeof JobInfoTable.$inferSelect, "id" | "name" | "title" | "description" | "experienceLevel">; }) => {
  ...
  const onSubmit = async (values: JobInfoFormData) => {
      ...
      <form onSubmit={ form.handleSubmit(onSubmit) } className='space-y-6'>
        ...
        <FormField control={ form.control } name='description' render={ ({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Textarea placeholder="A Next.js 15 and React 19 full stack web developer job that uses Drizzle ORM and Postgres for database management."
                { ...field } />
            </FormControl>
            <FormDescription>
