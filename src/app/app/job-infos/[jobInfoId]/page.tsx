...
const options = [
  ...
  },
  {
    ...
    description: "Get expert feedback on your resume and improve your chances of landing on interviews.",
    href: "resume"
  },
  {
    ...
    <div className="container my-4 space-y-4">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 has-hover:*:not-hover:opacity-70">
          { options.map((option) => (
            <Link className="hover:scale-[1.02] transition-[transform_opacity]" href={ `/app/job-infos/${jobInfoId}/${option.href}` } key={ option.href }>
